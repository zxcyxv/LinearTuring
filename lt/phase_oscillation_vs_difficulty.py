...
sys.path.insert(0,os.path.dirname(os.path.abspath(__file__))); from sudoku_solver import propagate, PEERS
d=np.load(os.path.join(SP,"phase_oscillation.npz")); X,Y,P=d["X"],d["Y"],d["P"]; NB=X.shape[0]
try:
