...
def main():
    ...
    os.makedirs("/workspace/mnist_model1/runs", exist_ok=True)
    torch.save({"model": model.state_dict(), "args": vars(args)},
               f"/workspace/mnist_model1/runs/{args.tag}.pt")
    json.dump(log, open(f"/workspace/mnist_model1/runs/{args.tag}_log.json", "w"))
