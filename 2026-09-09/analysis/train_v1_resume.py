...
CFG = dict(
    ...
    # ---- 실행/저장
    out_dir="/workspace/LinearTuring/2026-09-09/run_v1_resume",                 # None → /kaggle/working/checkpoints (없으면 ./lt_checkpoints)
    resume_from="/workspace/LinearTuring/2026-09-09/run_v1_resume/repro0901_step120000.pt",             # None → out_dir + /kaggle/input 자동 탐색. 명시하면 그 경로(파일/디렉터리)만 씀
    ...
    require_resume=True,         # True 면 재개할 체크포인트가 없을 때 즉시 중단 — 2회차 이후 세션에 켜라
