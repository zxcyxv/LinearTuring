...
ROOT=os.path.dirname(os.path.dirname(os.path.abspath(__file__))); torch.set_grad_enabled(False)
NB, SEG = 512, 512
...
json.dump(res, open(os.path.join(os.environ.get("LT_OUT", os.path.join(ROOT,"runs","analysis")), "es512.json"),"w"), ensure_ascii=False, indent=1)
