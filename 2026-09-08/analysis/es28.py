...
def run(es_new, S0):
    ...
    return dict(es=es_new, S0=S0, es0=es0, exact=out_ex, cell=out_cell, clue_keep=out_ck, hnorm=out_hn), P

CFGS=[(7.602,0)] + [(v,0) for v in (12,16,20,24,28,32,40)] + [(28,192),(28,16)]
res=[]; Pbase=None
...
json.dump(res, open("/tmp/claude-0/-workspace-LinearTuring/8092b54b-030b-4f2c-b7a7-8107892a6681/scratchpad/es28.json","w"), ensure_ascii=False, indent=1)
